...
Database = "BizIntel"
StartDate = date(2012, 10, 1)
EndDate = date(2012, 10, 2)
...
Monthly = dataDF.resample('M', how=['first','sum'])
print Monthly.head()
...
# data set
data = []
# Revenue was decimal converting to float
data = list(dataDF['Revenue'].astype(np.float64))
#print data
